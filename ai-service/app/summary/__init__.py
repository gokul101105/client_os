...
text, so both the retrieval strategy and the Claude call shape genuinely
differ from app/rag's single-turn Q&A. retrieval.py fetches chunks,
prompt.py builds what's sent to Claude, pipeline.py wires them together
via app/llm's forced-tool-use call.
"""
